...
namespace Shop
{
    public class Warzywa : Produkt
    {
        public Warzywa(string nazwa, string spozycDo, double waga, string skad) : base (nazwa, spozycDo, waga, skad)
        {
        ...
        {
            Console.WriteLine("----------------------------{0}Warzywo: {1}{0}", Environment.NewLine, Nazwa);
        }
        ...
        public static void WprowadzProdukt()
        {
            ...
            Console.Write("{0}Podaj nazwę warzywa: ", Environment.NewLine);
            ...
            Warzywa NowyProdukt = new Warzywa(nazwa, spozycDo, waga, skad);
